...
# Unit tests for OpenapiClient::ChainInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ChainInfo do
  let(:instance) { OpenapiClient::ChainInfo.new }

  describe 'test an instance of ChainInfo' do
    it 'should create an instance of ChainInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ChainInfo)
    end
  end
