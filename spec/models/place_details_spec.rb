...
# Unit tests for OpenapiClient::PlaceDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlaceDetails do
  let(:instance) { OpenapiClient::PlaceDetails.new }

  describe 'test an instance of PlaceDetails' do
    it 'should create an instance of PlaceDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PlaceDetails)
    end
  end
  ...
  describe 'test attribute "additional_locations"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
