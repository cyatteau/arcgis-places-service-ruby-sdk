...
module OpenapiClient
  ...
  class Configuration
    ...
    def initialize
      ...
      @base_path = '/arcgis/rest/services/places-service/v1'
      @server_index = nil
        ...
        'ArcGISTokenParameter' =>
          {
            ...
            in: 'query',
            key: 'token',
            value: api_key_with_prefix('ArcGISTokenParameter')
          },
        ...
        'ArcGISXEsriAuthorizationHeader' =>
          {
            type: 'bearer',
            in: 'header',
            format: 'X-Esri-Authorization: Bearer <YOUR_TOKEN>',
            key: 'Authorization',
            value: "Bearer #{access_token_with_refresh}"
          },
      }
    ...
    def server_settings
      [
        {
          url: "https://places-api.arcgis.com/arcgis/rest/services/places-service/{basePath}",
          description: "Production service endpoint.",
          variables: {
            basePath: {
                description: "Version 1 of the places service.",
                default_value: "v1",
              }
            }
        }
