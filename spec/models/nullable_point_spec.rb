...
# Unit tests for OpenapiClient::NullablePoint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NullablePoint do
  let(:instance) { OpenapiClient::NullablePoint.new }

  describe 'test an instance of NullablePoint' do
    it 'should create an instance of NullablePoint' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::NullablePoint)
    end
  end
