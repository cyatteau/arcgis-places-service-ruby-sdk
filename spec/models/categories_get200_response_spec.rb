...
# Unit tests for OpenapiClient::CategoriesGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CategoriesGet200Response do
  let(:instance) { OpenapiClient::CategoriesGet200Response.new }

  describe 'test an instance of CategoriesGet200Response' do
    it 'should create an instance of CategoriesGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CategoriesGet200Response)
    end
  end
