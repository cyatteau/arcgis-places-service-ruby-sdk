...
# Unit tests for OpenapiClient::WithinExtentResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WithinExtentResult do
  let(:instance) { OpenapiClient::WithinExtentResult.new }

  describe 'test an instance of WithinExtentResult' do
    it 'should create an instance of WithinExtentResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WithinExtentResult)
    end
  end
