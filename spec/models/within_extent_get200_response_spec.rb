...
# Unit tests for OpenapiClient::WithinExtentGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WithinExtentGet200Response do
  let(:instance) { OpenapiClient::WithinExtentGet200Response.new }

  describe 'test an instance of WithinExtentGet200Response' do
    it 'should create an instance of WithinExtentGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WithinExtentGet200Response)
    end
  end
