...
# Unit tests for OpenapiClient::Hours
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Hours do
  let(:instance) { OpenapiClient::Hours.new }

  describe 'test an instance of Hours' do
    it 'should create an instance of Hours' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Hours)
    end
  end
  ...
  describe 'test attribute "popular"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "opening_text"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
