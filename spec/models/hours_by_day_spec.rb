...
# Unit tests for OpenapiClient::HoursByDay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HoursByDay do
  let(:instance) { OpenapiClient::HoursByDay.new }

  describe 'test an instance of HoursByDay' do
    it 'should create an instance of HoursByDay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::HoursByDay)
    end
  end
