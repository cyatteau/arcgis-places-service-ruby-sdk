...
# Unit tests for OpenapiClient::NearPointGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NearPointGet200Response do
  let(:instance) { OpenapiClient::NearPointGet200Response.new }

  describe 'test an instance of NearPointGet200Response' do
    it 'should create an instance of NearPointGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::NearPointGet200Response)
    end
  end
