...
# Unit tests for OpenapiClient::Rating
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Rating do
  let(:instance) { OpenapiClient::Rating.new }

  describe 'test an instance of Rating' do
    it 'should create an instance of Rating' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Rating)
    end
  end
  ...
  describe 'test attribute "price"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cheap", "moderate", "expensive", "veryExpensive"])
      # validator.allowable_values.each do |value|
      #   expect { instance.price = value }.not_to raise_error
      # end
    end
  end
