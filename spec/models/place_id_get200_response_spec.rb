...
# Unit tests for OpenapiClient::PlaceIdGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlaceIdGet200Response do
  let(:instance) { OpenapiClient::PlaceIdGet200Response.new }

  describe 'test an instance of PlaceIdGet200Response' do
    it 'should create an instance of PlaceIdGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PlaceIdGet200Response)
    end
  end
