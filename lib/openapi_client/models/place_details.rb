...
module OpenapiClient
  # The additional details for a `Place`, including address, contact details, opening hours, and rating.   You can request additional details for a place by using the `placeId` in a `places/{placeId}` request. Use the `requestedFields` query parameter to choose the fields or attributes that are included in the response. 
  class PlaceDetails
    # The unique Id of this place.

    attr_accessor :place_id

    # A list of category objects for a place.  Categories are uniquely identified by a `categoryId`. For example, `17119` identifies a \"Bicycle Store\" and `10051` identifies a \"Stadium\". Note that a single place can belong to multiple categories (for example, a petrol station could also have a super-market).  This property is part of the \"Place\" attribute group. 
    attr_accessor :categories

    # The name of the place, or point of interest.  This property is part of the \"Place\" attribute group. 
    attr_accessor :name

    attr_accessor :location

    # A text description of the place.  This property is part of the \"Details\" attribute group. 
    ...
    # Information about all the chains the place belongs to.  This object and child properties are part of the \"Details\" attribute group. 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PlaceDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PlaceDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'additional_locations')
        self.additional_locations = attributes[:'additional_locations']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address == o.address &&
          additional_locations == o.additional_locations &&
    ...
    def hash
      [place_id, categories, name, location, description, address, additional_locations, contact_info, social_media, hours, rating, chains].hash
    end
