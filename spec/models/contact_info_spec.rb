...
# Unit tests for OpenapiClient::ContactInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContactInfo do
  let(:instance) { OpenapiClient::ContactInfo.new }

  describe 'test an instance of ContactInfo' do
    it 'should create an instance of ContactInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ContactInfo)
    end
  end
