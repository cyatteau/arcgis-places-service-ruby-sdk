...
# Unit tests for OpenapiClient::CategoryDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CategoryDetails do
  let(:instance) { OpenapiClient::CategoryDetails.new }

  describe 'test an instance of CategoryDetails' do
    it 'should create an instance of CategoryDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CategoryDetails)
    end
  end
  ...
  describe 'test attribute "full_label"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
