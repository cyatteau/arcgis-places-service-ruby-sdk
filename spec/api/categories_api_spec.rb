...
describe 'CategoriesApi' do
  ...
  # @param category_id The ID of the category that you want to fetch details for.  For example, using a category ID of &#x60;13035&#x60; would fetch details about the \&quot;Coffee Shop\&quot; category. 
