...
# Unit tests for OpenapiClient::TimeRange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimeRange do
  let(:instance) { OpenapiClient::TimeRange.new }

  describe 'test an instance of TimeRange' do
    it 'should create an instance of TimeRange' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TimeRange)
    end
  end
