...
# Unit tests for OpenapiClient::AdditionalLocations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AdditionalLocations do
  let(:instance) { OpenapiClient::AdditionalLocations.new }

  describe 'test an instance of AdditionalLocations' do
    it 'should create an instance of AdditionalLocations' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AdditionalLocations)
    end
  end
  ...
  describe 'test attribute "front_door"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
