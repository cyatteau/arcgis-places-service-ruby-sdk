...
# Unit tests for OpenapiClient::NearPointResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NearPointResult do
  let(:instance) { OpenapiClient::NearPointResult.new }

  describe 'test an instance of NearPointResult' do
    it 'should create an instance of NearPointResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::NearPointResult)
    end
  end
