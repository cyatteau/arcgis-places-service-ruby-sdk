...
# Unit tests for OpenapiClient::SocialMedia
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SocialMedia do
  let(:instance) { OpenapiClient::SocialMedia.new }

  describe 'test an instance of SocialMedia' do
    it 'should create an instance of SocialMedia' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SocialMedia)
    end
  end
