...
# Unit tests for OpenapiClient::ErrorError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorError do
  let(:instance) { OpenapiClient::ErrorError.new }

  describe 'test an instance of ErrorError' do
    it 'should create an instance of ErrorError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ErrorError)
    end
  end
  ...
  describe 'test attribute "code"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Integer', [400, 401, 403, 404, 498, 499, 500])
  ...
  describe 'test attribute "rest_info_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
